          ...
          <div className="flex items-center gap-3">
            {social.map(({ key, href, icon }) => (
              <Link
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full border border-primary/15 bg-white text-primary-600 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
                aria-label={f[key]}
              >
                {icon === "wa" && (
